...
<section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
  ...
  {/* OVERLAY */}
  <div className="absolute inset-0 bg-[#ede6da]/00" />
...
<section className="relative h-[100dvh] flex items-center justify-center overflow-hidden">
  ...
  <div
    className="absolute inset-0 bg-cover bg-center scale-105"
    style={{ backgroundImage: "url('/aq1.jpeg')" }}
  />
...
<section className="relative h-[100dvh] flex items-center justify-center overflow-hidden">
  ...
  <div
    className="absolute inset-0 bg-cover bg-center scale-105"
    style={{ backgroundImage: "url('/aq6.jpeg')" }}
  />
...
<div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/50 to-black/50" />
  ...
  <div className="relative z-10 w-full max-w-[420px] text-center px-6 py-16 text-black">
    ...
    {/* Құрметті */}
    <h2
      className="text-5xl italic mb-6 font-light text-[#FFFFFF]"
      style={{ letterSpacing: "2px" }}
    >
      Құрметті
    </h2>
    ...
    {/* Список гостей */}
    <p className="text-[23px] leading-[40px] italic text-[#FFFFFF]">
      Ағайын-туыс, бауырлар,<br />
      құда-жекжат,<br />
      нағашы-жиен, бөлелер,<br />
      дос-жаран, көршілер мен<br />
    ...
    {/* Разделитель */}
    <div className="flex items-center gap-3 my-8">
      <div className="flex-1 h-[1px] bg-gradient-to-r from-transparent to-[#FFFFFF]/40" />
      <div className="w-1.5 h-1.5 rotate-45 bg-[#FFFFFF]/60" />
      <div className="flex-1 h-[1px] bg-gradient-to-l from-transparent to-[#FFFFFF]/40" />
    </div>

    {/* Шақырту текст */}
    <p className="text-[23px] italic text-[#FFFFFF] mb-1">
      Сіздерді аяулы қызымыз
    </p>
   {/* Имя в карточке */}
     <div className="relative text-center py-6 px-4 my-2">
      ...
      {/* Главное имя */}
      <h1
        className="text-[64px] italic text-[#FFFFFF] leading-none"
        style={{
          fontFamily: "var(--font-kz-ceremonious)",
          letterSpacing: "-1px",
        }}
    ...
    <p className="text-[23px] leading-[40px] italic text-[#FFFFFF] mt-5">
      Ұзату тойына арналған<br />
      салтанатты ақ дастарханымыздың<br />
      қадірлі қонағы болуға<br />
      шақырамыз!
    ...
    {/* Нижний орнамент */}
    <div className="flex items-center justify-center gap-3 mt-8">
      <div className="w-10 h-[1px] bg-[#FFFFFF]/40" />
      <div className="w-1.5 h-1.5 rotate-45 bg-[#FFFFFF]/50" />
      <div className="w-10 h-[1px] bg-[#FFFFFF]/40" />
    </div>
  </div>
</section>
...
<section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 w-full max-w-[420px] text-center px-6 py-16 text-black">
    ...
    {/* Той иелері */}
    <p className="text-xl italic text-[#FFFFFF] tracking-wide mb-4">
      Құрметпен, той иелері
    </p>

    <h2
      className="text-3xl italic mb-6 font-light text-[#FFFFFF]"
      style={{ letterSpacing: "2px" }}
    >
      Бақытжан-Мадина
    </h2>
    ...
    <h2 className="text-2xl italic mb-4 font-light text-[#FFFFFF]">
      Той салтанаты:
    </h2>
{/* ===== ДАТА + КАЛЕНДАРЬ + ВРЕМЯ ===== */}

{/* Текст даты */}
<p className="text-2xl italic text-[#FFFFFF] mb-6">
  24 Маусым 2026
</p>
...
{/* Время снизу */}
<p className="text-2xl italic text-[#FFFFFF]">
  Сағат 19:00-де
</p>
<p className="uppercase tracking-[8px] text-[11px] text-[#c9a96e] mb-10">
    ...
    {/* Мекенжайы */}
    <h2 className="text-2xl italic mb-5 font-light text-[#FFFFFF]">
      Мекенжайы
    </h2>
    ...
    <div
      ...
      style={{
        border: "1.5px solid #d4b87a",
        borderRadius: "14px",
        background: "rgba(237, 146, 146, 0.55)",
        backdropFilter: "blur(6px)",
      }}
    >
      {/* Иконка геолокации */}
      ...
      <div>
        <p className="text-[20px] italic font-medium text-[#50070E] leading-tight">Qobyz    мейрамханасы</p>
        <p className="text-[17px] text-[#d4b87a] italic leading-snug mt-0">
          Тараз қаласы,<br />Әл-Фараби көшесі 68
        </p>
      </div>
    </div>
...
<section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
  ...
  <div className="relative z-10 w-full max-w-[360px] text-center px-6 py-16 text-black">
    ...
    <p className="text-[23px] italic leading-relaxed text-[#FFFFFF] mb-6">
      Тойға келетініңізді<br />
      растауыңызды сұраймыз
    </p>
    ...
    <div className="flex items-center justify-center gap-3 mt-10">
      <div className="w-10 h-[1px] bg-[#FFFFFF]/40" />
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        <path d="M12 2 C12 2 8 8 12 12 C16 8 12 2 12 2Z" fill="#FFFFFF" opacity="0.6"/>
        <path d="M12 22 C12 22 8 16 12 12 C16 16 12 22 12 22Z" fill="#FFFFFF" opacity="0.4"/>
        <path d="M2 12 C2 12 8 8 12 12 C8 16 2 12 2 12Z" fill="#FFFFFF" opacity="0.35"/>
        <path d="M22 12 C22 12 16 8 12 12 C16 16 22 12 22 12Z" fill="#FFFFFF" opacity="0.35"/>
      </svg>
      <div className="w-10 h-[1px] bg-[#b68b3c]/40" />
    </div>
